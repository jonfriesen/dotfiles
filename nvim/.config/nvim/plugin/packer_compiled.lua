...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/jon/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  ["cmp-nvim-lsp-signature-help"] = {
    loaded = true,
    path = "/Users/jon/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp-signature-help",
  ...
  ["lazygit.nvim"] = {
    loaded = true,
    path = "/Users/jon/.local/share/nvim/site/pack/packer/start/lazygit.nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/jon/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ripgrep = {
    loaded = true,
    path = "/Users/jon/.local/share/nvim/site/pack/packer/start/ripgrep",
...
try_loadstring("\27LJ\2\n*\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\15lsp_config\frequire\0", "config", "mason.nvim")
